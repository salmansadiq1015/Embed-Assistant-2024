          ...
          <div className="grid grid-cols-1 md:grid-cols-2 mt-[2.5rem]">
            <div className="flex flex-col gap-4 py-4 px-3 sm:px-4 rounded-xl shadow-md bg-gray-100 dark:bg-gray-800">
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="text-[17px] text-gray-800 dark:text-gray-200">
                  Easily embed the chatbot anywhere you need by simply copying
                  and pasting the ready-made code. No coding skills required to
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="text-[17px] text-gray-800 dark:text-gray-200">
                  Choose to share your chatbot publicly by embedding it or keep
                  it for private use within your account. Maintain control over
                  who can access and interact with your chatbot.
                </p>
              </div>
              {/*  */}
              <div className=" flex flex-col gap-2">
                ...
                <p className="text-[17px] text-gray-800 dark:text-gray-200">
                  Scale automation up and down instantly to manage fluctuations
                  in customer inquiries and demands. Ensure consistent customer
