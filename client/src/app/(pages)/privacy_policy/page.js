            ...
            <div className="px-4 sm:px-10 py-8 font-medium bg-gray-100 dark:bg-gray-800 rounded-xl translate-y-[-4rem]">
              ...
              <div className="flex flex-col gap-4 mt-[2rem]">
                <p className="text-[17px] text-gray-800 dark:text-gray-200">
                  This Privacy Policy describes how AI Powered Chatbots Trained
                  On Your Data ("Mediguide360.ai", "we", "us", or "our")
                  collects, uses, and shares your information when you use our
                  website (the "Service") or interact with our AI chatbots.
                </p>
                <p className="text-[17px] text-gray-800 dark:text-gray-200">
                ...
                <p className="text-[17px] text-gray-800 dark:text-gray-200">
                  ...
                  when you register for an account, such as your name, email
                  address, and contact information. We may also collect payment
                  information when you purchase a subscription or make a
                ...
                <p className="text-[17px] text-gray-800 dark:text-gray-200">
                  ...
                  our chatbots, including any personal information or data
                ...
                <p className="text-[17px] text-gray-800 dark:text-gray-200">
                  ...
                  configure your browser to refuse all cookies or to indicate
                  when a cookie is being sent. However, if you do not accept
                  cookies, you may not be able to use some portions of the
                  Service.
                </p>
                <b className="text-[19px] font-semibold">
                ...
                <p className="text-[17px] text-gray-800 dark:text-gray-200">
                  ...
                  <b className="font-semibold">
                    infraDev.cloudSupport@gmail.com
                  </b>
                  .
                </p>
