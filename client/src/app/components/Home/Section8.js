...
export default function Section8() {
  ...
  return (
    <div className="relative w-full min-h-[100vh] py-[1.5rem] px-2 sm:px-6 mt-[3.5rem] bg-gray-100 dark:bg-gray-800 rounded-lg  ">
      <div className="section6-content flex flex-col gap-4 items-center justify-center ">
        ...
        <p
          className="text-lg sm:text-2xl font-light text-blue-500 text-center"
          style={{
            color:
              theme === "dark"
                ? color
      ...
      {/* case1 */}
      <div
        className="grid grid-cols-1 sm:grid-cols-2 mt-[3rem] rounded-md overflow-hidden"
        style={{
          background:
            theme === "dark"
              ? color
      ...
      {/* case2 */}
      <div
        className="grid grid-cols-1 sm:grid-cols-2 mt-[3rem] rounded-lg overflow-hidden"
        style={{
          background:
            theme === "dark"
              ? color
      ...
      >
        <div
          className="flex flex-col gap-4 py-[1.5rem] px-[1rem]"
          style={{
            background:
              theme === "dark"
                ? color
